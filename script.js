const candidates = [
    ...
    { firstName: 'Angela Caroll', role: 'Chief Editor', photo: 'img/angela-caroll-chief-editor.jpg' },
    ...
    { firstName: 'Barbara Ramos', role: 'Graphic Designer', photo: 'img/barbara-ramos-graphic-designer.jpg' }
]
...
for (let candidate of candidates) {
    ...
    printDom.innerHTML = `${firstName}, <img src="${photo}">`
}
